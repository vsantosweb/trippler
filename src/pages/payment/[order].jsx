...
function Payment({ layout }) {
    ...
    const { register, watch, formState: { isValid } } = useForm({ mode: 'onChange' });
                ...
                <Styled.PaymentMethods>
                    <form>
                        <Styled.PaymentMethod>
                            ...
                            <CreditCard order={order} validFields={(isValid) => setPaymentMethodisValid(isValid)} register={register} />}
                    ...
                    <Button disabled={!paymentMethodisValid} onClick={() => setOpenPayMent(false)} color={'primary'}>Finalizar Compra</Button>
